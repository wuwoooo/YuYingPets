...
CREATE TABLE `grade_config` (
    ...
    INDEX `grade_config_school_id_idx`(`school_id`),
    INDEX `grade_config_school_id_status_idx`(`school_id`, `status`),
    UNIQUE INDEX `grade_config_school_id_code_key`(`school_id`, `code`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `pet` (
    ...
    UNIQUE INDEX `pet_school_id_code_key`(`school_id`, `code`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `display_terminal` (
    ...
    UNIQUE INDEX `display_terminal_terminal_code_key`(`terminal_code`),
    INDEX `display_terminal_school_id_idx`(`school_id`),
    INDEX `display_terminal_class_id_idx`(`class_id`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `display_config` (
    ...
    `weather_latitude` DECIMAL(10, 6) NULL,
    `weather_longitude` DECIMAL(10, 6) NULL,
...
-- AddForeignKey
ALTER TABLE `grade_config` ADD CONSTRAINT `grade_config_school_id_fkey` FOREIGN KEY (`school_id`) REFERENCES `school`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `display_terminal` ADD CONSTRAINT `display_terminal_school_id_fkey` FOREIGN KEY (`school_id`) REFERENCES `school`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `display_terminal` ADD CONSTRAINT `display_terminal_class_id_fkey` FOREIGN KEY (`class_id`) REFERENCES `class`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `display_terminal` ADD CONSTRAINT `display_terminal_initialized_by_fkey` FOREIGN KEY (`initialized_by`) REFERENCES `user`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
